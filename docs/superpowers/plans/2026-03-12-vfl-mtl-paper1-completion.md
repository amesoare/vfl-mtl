...
- [x] `data_prep/vertical_split.py` — MIMIC-III → three site CSVs (mean-aggregated per stay)
- [x] `data_prep/psi_alignment.py` — SHA-256 simulated PSI, produces `aligned_patient_ids.csv`
...
- [x] `requirements.txt` — torch, opacus, numpy, pandas, sklearn, scipy, matplotlib, seaborn, pytest
...
Vertical splits **already exist on Snellius** at `/home/asoare/vfl_mlt/data/`:
- `site_A_vitals.csv`
- `site_B_labs.csv`
