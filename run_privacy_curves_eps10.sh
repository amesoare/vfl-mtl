...
#SBATCH --mem=56G
#SBATCH --job-name=vfl_dp_eps10
#SBATCH --mail-type=FAIL,TIME_LIMIT
#SBATCH --output=slurm-%j-dp_eps10.out
#SBATCH --error=slurm-%j-dp_eps10.err

# ε=10 uniform — weakest DP level.
...
echo "=== DP curves ε=10 started: $(date) ==="
...
python -u experiments/privacy_utility_curves.py \
    ...
    --device cuda \
    --epsilon_levels 10.0 \
    --output results/privacy_utility_eps10.csv

echo "=== DP curves ε=10 finished: $(date) ==="
