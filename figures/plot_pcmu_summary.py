...
Usage:
    python figures/plot_pcmu_summary.py
    python figures/plot_pcmu_summary.py --input results/pcmu_paper_results_raw.csv \
                                         --output figures/pcmu_summary.png
"""
...
def main() -> None:
    ...
    parser.add_argument("--output", default="figures/pcmu_summary.png")
