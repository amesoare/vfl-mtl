...
Usage:
    ...
    # test set
    python figures/plot_ablations.py --source test \
        --input results/test_ablations.csv --output figures/ablations_test.png
"""
...
def main():
    ...
    if args.output is None:
        args.output = "figures/ablations_test.png" if is_test else "figures/ablations.png"
