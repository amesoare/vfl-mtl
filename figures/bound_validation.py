"""
figures/bound_validation.py — Figure 3: Theoretical Bound vs. Empirical Inference AUC.
...
Usage:
    python figures/bound_validation.py \
        --input results/bound_validation.csv \
        --output figures/bound_validation.png
"""
...
def main():
    ...
    parser.add_argument("--output", default="figures/bound_validation.png")
